...
- `testing.md`: 覆盖率、兼容性、fuzz、性能门禁
- `maintenance.md`: 维护节奏与响应目标
- `ecosystem.md`: 生态集成优先级
- `compliance.md`: 协议、合规、免责声明
...
- `testing.md`: coverage, compatibility, fuzzing, performance gates
- `maintenance.md`: maintenance cadence and response targets
- `ecosystem.md`: ecosystem integration priorities
- `compliance.md`: licensing, compliance, disclaimers
- `releases/`: versioned release-document snapshots
